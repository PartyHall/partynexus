...
export default function Participant({ event, participant, owner, canRemove }: Props) {
...

        {
            ...
            && <Tooltip content={t('events.editor.participants.remove')}>
                <ConfirmButton
                    ...
                    tDescriptionArgs={{username: (participant.firstname || participant.lastname) ? `${participant.firstname} ${participant.lastname}` : participant.username}}
