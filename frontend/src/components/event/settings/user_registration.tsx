...
export default function SettingsUserRegistration() {
    ...
    return <div className="flex flex-col gap-2">
        ...
        <div className="text-center">
            <a href={event.userRegistrationUrl} rel="noopener" target="_blank">{t('events.settings.user_registration.link')}</a>
        </div>

        <p className="text-sm italic text-center mt-2">{t('events.settings.user_registration.appliance_qr')}</p>
    </div>;
}