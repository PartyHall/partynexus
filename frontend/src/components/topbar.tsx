...
export function TopBar() {
  ...
  return (
    <nav className="bg-synthbg-800">
      ...
      <div
        id="mobile-menu"
        className={`md:hidden ${opened ? "" : "hidden"} px-2 pt-2 pb-3 space-y-1 flex flex-col gap-2 items-center fixed w-full bg-synthbg-800 z-1000`}
      >
        {links.map((link) => (
          <Link
            key={link.to}
