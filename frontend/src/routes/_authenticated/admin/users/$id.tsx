...
function RouteComponent() {
  ...
  useTranslatedTitle("admin.users.title_edit", "admin.title", {
    username: userFullName,
  });

  return (
    <div className="pageContainer">
      <Title noMargin>{userFullName}</Title>

      <Card className="w-full sm:w-150">
        <Title className="text-center" level={2} noMargin>
          {t("generic.edit")}
        </Title>
      ...
      <Card className="w-full sm:w-150 flex flex-col gap-4">
        <Title className="text-center" level={2} noMargin>
          {t("admin.users.management.title")}
        </Title>
