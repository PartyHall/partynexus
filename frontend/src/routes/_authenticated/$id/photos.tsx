...
import { Counter, Fullscreen, Download, Zoom } from 'yet-another-react-lightbox/plugins';
...
function RouteComponent() {
  ...
  return <div className="grid grid-cols-1 gap-0.5 gallery-md:grid-cols-3 gallery-xs:grid-cols-2">
    {
