...
function RouteComponent() {
  ...
  return <form className='flex flex-col gap-1 sm:w-sm' onSubmit={handleSubmit(onSubmit)}>
...

    {
      ...
      && <span className='text-red-glow text-sm mt-1 text-center'>{t('register.password_mismatch')}</span>
    }
    ...
    <Button type='submit' className='mt-4' disabled={isSubmitting || (password !== passwordRepeat)}>
      {t('register.register')}
    </Button>
  </form>
}
